const ajouterErreurAuChamp = (ligne, col) => {
...
const verifier = () => {
	...
	// Récupérer tout les input de la page
	...
	// Vérifier pas de doublon en ligne 
...
// Vérifier que l'élément n'est pas dans la liste 
				if (valeurExiste) {
					...
					ajouterErreurAuChamp(ligne, col)
				} else {
...
// Ajouter l'élément à une liste
	...
	// Pour chaque carré
	// Utiliser les indices pour vérifier les doyublons
}
...
// Assigner l'évenement click à la function vérifier 
